...
function mergeSaved(obj,s){if(!obj||typeof obj!=='object')return obj;const input={...(obj.input_data||{}),...s,floors:s.floors};return {...obj,...s,input_data:input,utilities:s.utilities,floor_areas:s.floor_areas,floor_conditions:s.floor_conditions}}
