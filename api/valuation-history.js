...
@media(max-width:650px){.top h1{font-size:21px}.grid{grid-template-columns:1fr 1fr}.price{font-size:28px}.actions .btn{padding:10px 12px;font-size:13px}}
</style>
<script defer src="/valuation-history-client.js?v=22"></script>
<script defer src="/valuation-history-actions.js?v=22"></script>
<script defer src="/valuation-history-trends.js?v=22"></script>
<script defer src="/valuation-object-dossier.js?v=22"></script>
<script defer src="/valuation-history-grouping.js?v=22"></script>
</head>
<body>
