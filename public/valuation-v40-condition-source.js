...
function patchHouse(){const s=document.getElementById('structural_condition');if(!s)return;ensureUnknown(s,'house');const f=s.closest('.field')||s.parentElement;if(f&&!f.querySelector('.kh-v40-source-note')){const n=document.createElement('div');n.className='hint kh-v40-source-note';n.textContent=TXT.note;n.style.cssText='margin-top:7px;color:#687283;line-height:1.35';f.appendChild(n)}}
