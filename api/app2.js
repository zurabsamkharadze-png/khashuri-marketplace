  ...
  res.end=(body,...args)=>{
    try{
      ...
      if(ct.includes('text/html')&&body){
        ...
        const tag='<script src="/khashuri-inbox-reopen.js?v=4.0"></script>';
