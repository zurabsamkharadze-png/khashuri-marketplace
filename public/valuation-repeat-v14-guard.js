...
const zeroComponent=Number(raw.calculation_details?.outbuilding_component||x.calculation_details?.outbuilding_component||0)===0;
const legacy=zeroComponent||(code==='69.08.63.588'&&legacyShape&&(!created||created<cutoff));
if(!legacy)return;
